...
- **memory-crystal** ... Sovereign memory system for AI agents. Local-first hybrid search with ephemeral cloud mirror.
- **lesa-bridge** ... Cross-platform agent bridge. Claude Code talks to OpenClaw agents and searches shared memory.
